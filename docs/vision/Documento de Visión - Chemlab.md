...
En Educación Secundaria, la Química se imparte mayoritariamente desde un enfoque teórico debido a la limitación de recursos materiales, espacio y tiempo de laboratorio en los centros públicos. Esta carencia de práctica experimental dificulta que el alumnado consolide los conceptos fundamentales (estructura de la materia, reacciones, estequiometría, etc.) y se traduce en bajo rendimiento y desinterés hacia la asignatura.
...
| ---- | ------------------------------------------- | -------------- |
| 1    | MVP: tabla periódica interactiva + 1 módulo | Mes 2          |
| 2    | Sistema de ejercicios y feedback automático | Mes 4          |
| 3    | Persistencia de progreso y panel docente    | Mes 6          |
